...
from hyx.service.model_pack import process_image
# 从本地摄像头读取数据
...
def capture_and_save_images():
    ...
    for frame in get_camera_stream():
        ...
        image_path = os.path.join('images/faces/photo', f'image_{timestamp}.jpg')
...
def push_stream_from_camera(camera_index=0, rtmp_url=config.RTMP_URL):
    ...
    try:
        while True:
            ...
            frame, a, b = process_image(frame,"Front")
