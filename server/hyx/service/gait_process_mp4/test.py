...
def makeSegMask(img):
    ...
    # Create mini-batch to be used by the model_pack
...
def frame_capture(file):
    ...
    destination = '/home/hyx/Desktop/server/hyx/service/out'
...
if __name__ == '__main__':
    ...
    data_path = "/home/hyx/Desktop/server/hyx/service/video"
